...
class CustomEnableDilaog extends StatefulWidget {
  const CustomEnableDilaog({super.key});

  @override
  State<CustomEnableDilaog> createState() => _CustomEnableDilaogState();
}

class _CustomEnableDilaogState extends State<CustomEnableDilaog> {
  @override
